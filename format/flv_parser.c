 ...
 * License: StreamOcean
 * Last-Updated: 2017/08/27 17:41:33
 */
...
/* return BigEndian byte array into LittleEndian integer */
...
int flv_parser(char *url) {
    ...
    fseek(ifh, reverse_bytes((byte *)&flv.DataOffset, sizeof(flv.DataOffset)),
          SEEK_SET);
    ...
    do {
        ...
        int tagheader_timstamp = tagheader.Timestamp[0]*65536 +
        ...
        fprintf(myout, "[%6s] %6d %6d |", tagtype_str, tagheader_datasize,
                tagheader_timstamp);
        ...
        case TAG_TYPE_AUDIO: {
            ...
            case 14: strcat(audiotag_str, "MP3 8kHz"); break;
        ...
        case TAG_TYPE_VIDEO : {
            ...
            memcpy(&tagheader.Timestamp, ((char *)&ts_new) + 1,
