...
test()
{
    ...
    AVCodec *pCodec;
    char filepath[] = "/Users/lyt/good.mp4";
    ...
    if (videoindex == -1) {
        printf("Cound't find video stream\n");
        return -1;
    }
    ...
    SDL_WM_SetCaption("Simple FFmpeg Mem Player", NULL);
...
/* Local Variables: */
/* compile-command: "clang -Wall -o av_mem av_mem.c -g -lavformat -lavcodec -lavutil -lSDL2" */
/* End: */
